...
- **`v1.9.0` posée** (2026-07-22) : **validation ACCESSFOR (IGN), §3 élucidé**. `accessfor_correspondance()`
  ...
  pente). `classes_debardage()` généralisée au porteur. Reste : le livrable §5 (matrice de confusion
  sur Chastel-Nouvel, rasterisation `near`, intersection des masques, DEUX variantes ACCESSFOR).
