...
- **Lot en cours** : **Lot 4 — noyau câble (Rust)**. Spec
  `specs/004-cable.md` validée (2026-07-12). **4a** (caténaire + Newton)
  et **4b** (faisabilité de travée) livrés : 8 bindings extendr, 11
  tests cargo + 22 tests R. Suivant : 4c (optimisation des supports).
