...
- **Branche** : `main`
- **Version `DESCRIPTION`** : `0.5.0.9000` (cycle de dev ; `NEWS.md` et `CITATION.cff`
  restent sur `0.5.0`, la dernière release)
- **Lot en cours** : aucun. Lot 3 clos et publié (`v0.5.0`). Prochain : consolidation du
  porteur (dette assumée) ou **Lot 4 (noyau câble Rust)**.
