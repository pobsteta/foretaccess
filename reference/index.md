...
- [`acquire_mnt_rgealti()`](https://pobsteta.github.io/foretaccess/reference/acquire_mnt_rgealti.md)
  ...
  Acquiert un MNT RGE ALTI depuis les **dalles départementales**
  (Géoservices)
...
- [`acquire_obstacles_bdtopo()`](https://pobsteta.github.io/foretaccess/reference/acquire_obstacles_bdtopo.md)
  : Acquire ACCESSFOR-conformant obstacles from BD TOPO and INPN (spec
  022 volet B)
...
- [`desserte_dist_to_end()`](https://pobsteta.github.io/foretaccess/reference/desserte_dist_to_end.md)
  ...
  Lot 15a).
- [`desserte_trace()`](https://pobsteta.github.io/foretaccess/reference/desserte_trace.md)
  : Trace a forest road through mandatory waypoints (road-design A\\
  solver, Lot 15b).
...
- [`build_cvat_precomputed()`](https://pobsteta.github.io/foretaccess/reference/build_cvat_precomputed.md)
  : Precompute the CVAT relief over an AOI + buffer, guaranteeing
  coverage
